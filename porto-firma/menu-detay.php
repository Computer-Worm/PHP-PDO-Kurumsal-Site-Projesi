                    ...
                    <div class="col-md-12">
                        <span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
                            <span class="thumb-info-side-image-wrapper p-none hidden-xs">
                                <img src="<?php echo $menucek['menu_resimyol']; ?>" class="img-responsive" alt="<?php echo $menucek['menu_ad']; ?>" style="width: 300px; height: 250px; padding: 10px;">
                            </span>
                            <span class="thumb-info-caption">
                                <span class="thumb-info-caption-text">
                                    <p class="h3"> <?php echo $menucek['menu_detay']; ?> </p>
                                </span>
                            </span>
                        </span>
