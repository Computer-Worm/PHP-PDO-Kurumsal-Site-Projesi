    ...
    <div class="container">
        <div class="row pt-xl">
            <div class="col-md-4 col-md-offset-1">
                <h4 class="mt-xl mb-none"> <?php echo $hakkimizdacek['hakkimizda_video_basligi'] ?> </h4>
                <div class="divider divider-primary divider-small mb-xl">
                    <hr>
                </div>

                <div class="embed-responsive embed-responsive-16by9 mb-xl">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $hakkimizdacek['hakkimizda_video']; ?>?controls=0" frameborder="0" allowfullscreen></iframe>
                </div>
